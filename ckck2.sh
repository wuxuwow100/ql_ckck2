...
Get_Full_Name(){
    ...
    remarks_new[$j]="$(echo ${remarks_ori[$j]} | perl -pe "{s|$tmp_remarks_id_1|${remarks_id[$j]}|}")"
...
verify_ck(){
    ...
    wxpusher_json(){
        ...
        timestamp_ms="$(echo $(def_json JD_COOKIE $i remarks) | grep -Eo '@@([0-9]{13})' | grep -Eo '[0-9]{13}')"
